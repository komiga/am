...
/** @name Constructors */ /// @{
	...
	*/
	inline tmat2x2() /** @cond INTERNAL */: data{
		col_type{T(1), T(0)},
		col_type{T(0), T(1)}}/** @endcond */ {}
	/**
	...
	*/
	...
	/**
		...
		@param s Value.
	*/
	inline explicit tmat2x2(value_type const& s) /** @cond INTERNAL */: data{
		col_type{s, T(0)},
		col_type{T(0), s}}/** @endcond */ {}
	/**
		Construct to main diagonal.
	...
	*/
	template<typename U>
	inline explicit tmat2x2(U const& s) /** @cond INTERNAL */: data{
		col_type{T(s), T(0)},
		col_type{T(0), T(s)}}/** @endcond */ {}
	...
	*/
	inline explicit tmat2x2(value_type const& x1, value_type const& y1,
							value_type const& x2, value_type const& y2) /** @cond INTERNAL */: data{
		col_type{x1, y1},
	...
	*/
	...
	inline explicit tmat2x2(X1 const& x1, Y1 const& y1,
							X2 const& x2, Y2 const& y2) /** @cond INTERNAL */: data{
		col_type{T(x1), T(y1)},
	...
	*/
	...
	inline explicit tmat2x2(tvec2<C1> const& c1,
							tvec2<C2> const& c2) /** @cond INTERNAL */: data{
		col_type{c1},
		col_type{c2}}/** @endcond */ {}
	...
	*/
	inline tmat2x2(type const& m) /** @cond INTERNAL */: data{
		m.data[0],
		m.data[1]}/** @endcond */ {}
	/**
		Construct to matrix.
	...
	*/
	template<typename U>
	inline tmat2x2(tmat2x2<U> const& m) /** @cond INTERNAL */: data{
		col_type{m.data[0]},
