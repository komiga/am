...
/** @name Constructors */ /// @{
	...
	*/
	explicit tmat2x2(value_type const& x1, value_type const& y1,
					 value_type const& x2, value_type const& y2) : data{
		col_type{x1, y1},
		col_type{x2, y2}} {}
	/**
		Construct to values.
	...
	*/
	...
	>
	explicit tmat2x2(X1 const& x1, Y1 const& y1,
					 X2 const& x2, Y2 const& y2) : data{
		col_type{T(x1), T(y1)},
		col_type{T(x2), T(y2)}} {}
	...
	*/
	explicit tmat2x2(col_type const& c1,
	...
	*/
	...
	explicit tmat2x2(tvec2<C1> const& c1,
					 tvec2<C2> const& c2) : data{
		col_type{c1},
		col_type{c2}} {}
...
/** @name mat2x2 increment and decrement operators */ /// @{
	...
	*/
	template<typename T>
	inline tmat2x2<T> operator++(tmat2x2<T> const& m, signed) {
