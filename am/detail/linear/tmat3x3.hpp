...
#define AM_DETAIL_LINEAR_TMAT3X3_HPP_
...
/** @name Constructors */ /// @{
	...
	*/
	...
	>
	explicit tmat3x3(X1 const& x1, Y1 const& y1, Z1 const& z1,
					 X2 const& x2, Y2 const& y2, Z2 const& z2,
					 X3 const& x3, Y3 const& y3, Z3 const& z3) : data{
	...
	*/
	explicit tmat3x3(col_type const& c1,
					 col_type const& c2,
	...
	*/
	template<
		...
		typename C3
	>
	explicit tmat3x3(tvec3<C1> const& c1,
					 tvec3<C2> const& c2,
					 tvec3<C3> const& c3) : data{
		col_type{c1},
		col_type{c2},
		col_type{c3}} {}
...
/** @name mat3x3 increment and decrement operators */ /// @{
	...
	*/
	template<typename T>
	inline tmat3x3<T> operator++(tmat3x3<T> const& m, signed) {
...
#endif // AM_DETAIL_LINEAR_TMAT3X3_HPP_
