...
/** @name Constructors */ /// @{
	...
	*/
	explicit tmat4x4(
			...
			value_type const& z4, value_type const& w4) : data{
	...
	*/
	...
	explicit tmat4x4(
			...
			X4 const& x4, Y4 const& y4, Z4 const& z4, W4 const& w4) : data{
	...
	*/
	explicit tmat4x4(col_type const& c1,
					 col_type const& c2,
					 col_type const& c3,
	...
	*/
	template<
		...
		typename C4
	>
	explicit tmat4x4(tvec4<C1> const& c1,
					 tvec4<C2> const& c2,
					 tvec4<C3> const& c3,
					 tvec4<C4> const& c4) : data{
		col_type{c1},
		col_type{c2},
		col_type{c3},
		col_type{c4}} {}
...
/** @name mat4x4 increment and decrement operators */ /// @{
	...
	*/
	template<typename T>
	inline tmat4x4<T> operator++(tmat4x4<T> const& m, signed) {
